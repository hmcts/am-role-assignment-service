...
import static uk.gov.hmcts.reform.roleassignment.controller.utils.WireMockStubs.OBJECT_MAPPER;
import static uk.gov.hmcts.reform.roleassignment.security.BaseSecurityIntegrationTest.VALID_ISSUER_1;
import static uk.gov.hmcts.reform.roleassignment.security.BaseSecurityIntegrationTest.VALID_ISSUER_2;
...
public class JwtIssuerValidationDisabledIntegrationTest extends BaseSecurityIntegrationTest {
    ...
    void issuerValidationDisabled_shouldReturnExpectedStatus(String scenario,
        ...
        String request = OBJECT_MAPPER.writeValueAsString(ASSIGNMENT_REQUEST);
