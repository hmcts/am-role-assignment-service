...
@Slf4j
class CivilSystemRoleIntegrationTest extends BaseDroolIntegrationTest {
    ...
    @Nested
    @DisplayName("CaseAllocator system roles")
    class CaseAllocatorSystemRoleTests {

        @Test
        void shouldRegisterCivilSystemUserRole_CaseAllocator_SingleUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_CaseAllocator_MultipleUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_CaseAllocator_ReplaceUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_CaseAllocator_WithoutResettingOtherSystemRoles() throws Exception {
        ...
        @Test
        void shouldDeleteCivilSystemUserRole_CaseAllocator() throws Exception {
        ...
        @Test
        void shouldRejectCivilSystemUserRole_CaseAllocator_ReplaceExistingFalse() throws Exception {
        ...
        @Test
        void shouldRejectCivilSystemUserRole_CaseAllocator_WrongJurisdiction() throws Exception {
            ...
            AssignmentRequest assignmentRequest = AssignmentRequest.builder()
                ...
                .requestedRoles(List.of(
                    ...
                    createSystemRoleAssignment(uidSystemUser, ROLE_CASE_ALLOCATOR, JURISDICTION_WRONG)
                ))
                .build();
        ...
        @Test
        void shouldRejectCivilSystemUserRole_CaseAllocator_WrongS2SClientId() throws Exception {
        ...
        void shouldApproveCaseAllocationForCivilSystemUserRole() throws Exception {
    ...
    @Nested
    @DisplayName("CBUS system roles")
    class CbusSystemRoleTests {

        @Test
        void shouldRegisterCivilSystemUserRole_CBUS_SingleUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_CBUS_MultipleUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_CBUS_ReplaceUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_CBUS_WithoutResettingOtherSystemRoles() throws Exception {
        ...
        @Test
        void shouldDeleteCivilSystemUserRole_CBUS() throws Exception {
        ...
        @Test
        void shouldRejectCivilSystemUserRole_CBUS_ReplaceExistingFalse() throws Exception {
        ...
        @Test
        void shouldRejectCivilSystemUserRole_CBUS_WrongJurisdiction() throws Exception {
            ...
            AssignmentRequest assignmentRequest = AssignmentRequest.builder()
                ...
                .requestedRoles(List.of(
                    // NB: wrong Jurisdiction value
                    createSystemRoleAssignment(uidSystemUser, ROLE_CBUS_SYSTEM_USER, JURISDICTION_WRONG)
                ))
                .build();
        ...
        @Test
        void shouldRejectCivilSystemUserRole_CBUS_WrongS2SClientId() throws Exception {
    ...
    @Nested
    @DisplayName("Hearing system roles")
    class HearingSystemRoleTests {

        @Test
        void shouldRegisterCivilSystemUserRole_Hearing_SingleUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_Hearing_MultipleUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_Hearing_ReplaceUser() throws Exception {
        ...
        @Test
        void shouldRegisterCivilSystemUserRole_Hearing_WithoutResettingOtherSystemRoles() throws Exception {
        ...
        @Test
        void shouldDeleteCivilSystemUserRole_Hearing() throws Exception {
        ...
        @Test
        void shouldRejectCivilSystemUserRole_Hearing_ReplaceExistingFalse() throws Exception {
        ...
        @Test
        void shouldRejectCivilSystemUserRole_Hearing_WrongJurisdiction() throws Exception {
            ...
            AssignmentRequest assignmentRequest = AssignmentRequest.builder()
                ...
                .requestedRoles(List.of(
                    ...
                    createHearingSystemRoleAssignment(
                        uidSystemUser,
                        ROLE_HEARING_MANAGER,
                        JURISDICTION_WRONG,
                        CASE_TYPE
                    ),
                    createHearingSystemRoleAssignment(
        ...
        @Test
        void shouldRejectCivilSystemUserRole_Hearing_WrongS2SClientId() throws Exception {
