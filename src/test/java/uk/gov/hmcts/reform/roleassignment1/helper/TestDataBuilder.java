package uk.gov.hmcts.reform.roleassignment1.helper;
...
import uk.gov.hmcts.reform.roleassignment1.data.roleassignment.HistoryEntity;
import uk.gov.hmcts.reform.roleassignment1.data.roleassignment.RequestEntity;
import uk.gov.hmcts.reform.roleassignment1.data.roleassignment.RoleAssignmentEntity;
import uk.gov.hmcts.reform.roleassignment1.domain.model.ActorCache;
import uk.gov.hmcts.reform.roleassignment1.domain.model.AssignmentRequest;
import uk.gov.hmcts.reform.roleassignment1.domain.model.Request;
import uk.gov.hmcts.reform.roleassignment1.domain.model.Role;
...
import uk.gov.hmcts.reform.roleassignment1.domain.model.RoleAssignmentResource;
import uk.gov.hmcts.reform.roleassignment1.domain.model.enums.ActorIdType;
import uk.gov.hmcts.reform.roleassignment1.domain.model.enums.Classification;
import uk.gov.hmcts.reform.roleassignment1.domain.model.enums.GrantType;
import uk.gov.hmcts.reform.roleassignment1.domain.model.enums.RequestType;
import uk.gov.hmcts.reform.roleassignment1.domain.model.enums.RoleType;
import uk.gov.hmcts.reform.roleassignment1.domain.model.enums.Status;
import uk.gov.hmcts.reform.roleassignment1.util.JacksonUtils;
...
import static uk.gov.hmcts.reform.roleassignment1.apihelper.Constants.ROLES_JSON;
