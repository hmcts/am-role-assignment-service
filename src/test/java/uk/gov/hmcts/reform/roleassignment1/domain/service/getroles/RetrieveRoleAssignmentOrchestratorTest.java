...
class RetrieveRoleAssignmentOrchestratorTest {
    ...
    void getRoleAssignment_shouldGetAssignmentsByActor() throws Exception {
        ...
        List<RoleAssignment> roleAssignments = (List<RoleAssignment>) TestDataBuilder.buildRequestedRoleCollection();
        String actorId = "123e4567-e89b-42d3-a456-556642445678";
        ResponseEntity<Object> roles = TestDataBuilder.buildRoleAssignmentResponse();
