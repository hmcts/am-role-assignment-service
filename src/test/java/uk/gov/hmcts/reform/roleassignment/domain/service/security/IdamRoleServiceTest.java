...
class IdamRoleServiceTest {
    ...
    void getUserId() {
        ...
        assertEquals(userId, "6b36bfc6-bb21-11ea-b3de-0242ac140004");
    }
    ...
    void getUserRole() {
        ...
        assertEquals(userRole, "SomeRole");
    }

    @Test
    void getIdamRoleAssignmentsForActor() throws Exception {
        Collection<RoleAssignment> roleList = new ArrayList<>();
        //when(idamRoleService.getIdamRoleAssignmentsForActor("6b36bfc6-bb21-11ea-b3de-0242ac140004"))
        //    .thenReturn(roleList);
        Collection<RoleAssignment> result = idamRoleService.getIdamRoleAssignmentsForActor("6b36bfc6-bb21-11ea-b3de-0242ac140004");
