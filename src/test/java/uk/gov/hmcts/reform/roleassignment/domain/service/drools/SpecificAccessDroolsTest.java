...
class SpecificAccessDroolsTest extends DroolBase {
    ...
    @CsvSource({
        ...
        "DIVORCE,specific-access-judiciary,JUDICIAL,STANDARD",
        "DIVORCE,specific-access-legal-ops,LEGAL_OPERATIONS,STANDARD",
        "DIVORCE,specific-access-admin,ADMIN,STANDARD",
        "DIVORCE,specific-access-ctsc,CTSC,STANDARD"
    })
    ...
    @CsvSource({
        ...
        "DIVORCE,specific-access-judiciary,JUDICIAL",
        "DIVORCE,specific-access-legal-ops,LEGAL_OPERATIONS",
        "DIVORCE,specific-access-admin,ADMIN",
        "DIVORCE,specific-access-ctsc,CTSC"
    })
