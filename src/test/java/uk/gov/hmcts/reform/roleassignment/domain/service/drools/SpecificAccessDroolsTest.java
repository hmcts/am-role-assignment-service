...
class SpecificAccessDroolsTest extends DroolBase {
    ...
    @CsvSource({
        ...
        "CIVIL,specific-access-judiciary,JUDICIAL,judiciary-approver-role",
        "CIVIL,specific-access-admin,ADMIN,admin-approver-role",
        "CIVIL,specific-access-legal-ops,LEGAL_OPERATIONS,legal-ops-approver-role",
        "PRIVATELAW,specific-access-judiciary,JUDICIAL,specific-access-approver",
        "PRIVATELAW,specific-access-admin,ADMIN,specific-access-approver",
        "PRIVATELAW,specific-access-legal-ops,LEGAL_OPERATIONS,specific-access-approver",
    })
