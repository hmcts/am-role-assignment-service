...
class CaseRolesDroolsTest extends DroolBase {
    ...
    @CsvSource({
        ...
        "EMPLOYMENT,ET_EnglandWales,allocated-tribunal-caseworker,LEGAL_OPERATIONS,senior-tribunal-caseworker,,"
            + "APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-admin-caseworker,LEGAL_OPERATIONS,hearing-centre-admin,,APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-admin-caseworker,LEGAL_OPERATIONS,hearing-centre-team-leader,,APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-admin-caseworker,LEGAL_OPERATIONS,regional-centre-admin,,APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-admin-caseworker,LEGAL_OPERATIONS,regional-centre-team-leader,,APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-admin-caseworker,LEGAL_OPERATIONS,clerk,,APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-ctsc-caseworker,LEGAL_OPERATIONS,ctsc,,APPROVED",
        "EMPLOYMENT,ET_EnglandWales,allocated-ctsc-caseworker,LEGAL_OPERATIONS,ctsc-team-leader,,APPROVED",
    })
