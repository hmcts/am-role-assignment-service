    ...
    public ResponseEntity<Object> deleteRoleAssignment(String actorId,
        ...
        if (actorId != null) {
            ...
            if (requestedRoles.isEmpty()) {
                throw new ResourceNotFoundException(String.format(V1.Error.NO_RECORDS_FOUND_BY_ACTOR + "%s", actorId));
            }
            ...
            if (requestedRoles.isEmpty()) {
                throw new ResourceNotFoundException(String.format(V1.Error.NO_RECORDS_FOUND_BY_PROCESS,
                                                                  process,
                                                                  reference));
            }
        } else {
            ...
            if (requestedRoles.isEmpty()) {
                throw new ResourceNotFoundException(String.format(V1.Error.NO_RECORD_FOUND_BY_ASSIGNMENT_ID,
                                                                  assignmentId));
            }
        }
