...
public class Constants {
    ...
    public static final String CASE_DOCUMENT_NOT_FOUND
    ...
    public static final String CASE_DOCUMENT_HASH_TOKEN_INVALID =
        "Case document hash-token is not valid for document Id : %s";
    ...
    public static final String EXCEPTION_ERROR_ON_DOCUMENT_MESSAGE =
        "Exception occurred with operation on document id: %s because of %s";
    ...
    public static final String SERVICE_PERMISSION_ERROR =
        "Service doesn't have sufficient permission on requested API {}";
