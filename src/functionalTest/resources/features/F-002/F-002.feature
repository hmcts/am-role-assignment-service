...
#    And the response has all other details as expected.
  ...
  @S-025 @FeatureToggle(delete-role-assignments)
  ...
  @S-026 @FeatureToggle(delete-role-assignments)
  ...
  @S-029 @FeatureToggle(delete-role-assignments)
  ...
  @S-030 @FeatureToggle(delete-role-assignments)
