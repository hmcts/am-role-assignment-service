...
Feature: F-005 : Get Role Assignments by Actor Id
  ...
  @S-051 @FeatureToggle(get-role-assignments-by-actor-id)
  ...
  @S-052 @FeatureToggle(get-role-assignments-by-actor-id)
  ...
  @S-054 @FeatureToggle(get-role-assignments-by-actor-id)
  ...
  @S-056 @FeatureToggle(get-role-assignments-by-actor-id)
  ...
  @S-057 @FeatureToggle(get-role-assignments-by-actor-id)
  ...
  @S-058 @FeatureToggle(get-role-assignments-by-actor-id)
